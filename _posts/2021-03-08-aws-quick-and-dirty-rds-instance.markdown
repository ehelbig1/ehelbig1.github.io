...
A RDS Instance runs on a [VPC]({% post_url 2021-03-08-aws-quick-and-dirty-vpc.markdown %}).

# Create RDS Instance
Creates a RDS Instance.

## Prerequisites
[RDS Subnet Group]({% post_url 2021-03-08-aws-quick-and-dirty-rds-subnet-group.markdown %})
