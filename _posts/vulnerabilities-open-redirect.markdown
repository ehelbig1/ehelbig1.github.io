...
Both these solutions prevent a user from defining an arbitrary redirect URL but sometimes it may not be feasible to completely remove this functionally from an application however.
